          ...
          {matchData && initialTeamMapping.CT && initialTeamMapping.T && (
            <div className="bg-gray-800 rounded-lg shadow-lg p-4 border border-gray-700">
              <div className="flex items-center gap-2 mb-3">
                ...
                <InfoTooltip
                  content="Track team economy, equipment value, and round outcomes over time. Analyze how economic advantages translate to tactical success."
                  side="right"
                />
              </div>
                    ...
                    <div className="space-y-2 text-sm text-gray-300">
                      ...
                      <ol className="list-decimal list-inside space-y-2">
                        ...
                        <li className="leading-relaxed">
                          ...
                          - Configure timepoints, clustering method, and
                          reduction technique
                        </li>
                        <li className="leading-relaxed">
                          <strong className="text-gray-200">
                          ...
                          {labelsRef.current && (
                            <div className="flex items-center justify-between">
                              ...
                              <span className="text-green-400 font-bold">
                                {
                                  new Set(
                                    labelsRef.current.filter((l) => l >= 0)
                                  ).size
                                }
                              </span>
                            </div>
